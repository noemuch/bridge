...
const FIX_COMPONENTS = {
  version: 1, generatedAt: "2026-04-15T10:00:00Z",
  components: [
    { key: "k1", name: "Button", category: "actions" as const, status: "stable" as const, variants: [], properties: [] },
    { key: "k2", name: "Link", category: "actions" as const, status: "stable" as const, variants: [], properties: [] },
  ],
};
const FIX_VARIABLES = {
  version: 1, generatedAt: "2026-04-15T10:00:00Z",
  variables: [{ key: "v1", name: "color/bg/primary", resolvedType: "COLOR" as const, valuesByMode: { light: {}, dark: {} } }],
};
...
test("buildFromScratch produces valid _index.json structure", () => {
  const idx = buildFromScratch({
    components: FIX_COMPONENTS, variables: FIX_VARIABLES, textStyles: FIX_TEXT_STYLES,
    learnings: { learnings: [], flags: [] }, recipes: { recipes: [] },
  });
